...
urlpatterns = [
    ...
    url(r'^admin-dash/logout/$', AdminLogoutView.as_view(), name='adminlogout'),
    url(r'^admin-dash/create/$', AdminCreateView.as_view(), name='admincreate'),
    url(r'^admin-dash/read/$', AdminReadView.as_view(), name='adminread'),
